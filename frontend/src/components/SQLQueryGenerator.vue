<template>
  <div class="tool-page">
    <h2 class="text-3xl font-bold mb-4">SQL Query Generator</h2>
    <p class="text-lg mb-6">
      <strong>Description</strong>: The SQL Query Generator helps you create SQL queries effortlessly. Simply provide the table name, select columns, and add conditions.
    </p>
    <div class="tool-example mb-6">
      ...
      <div class="example-section mb-4">
        ...
        <p class="bg-gray-100 p-2 rounded">Table Name: Orders<br>Columns: id, user_id, product, quantity<br>Conditions: quantity > 10, product = 'Laptop'</p>
      </div>
    </div>
    <div class="tool-form">
    ...
    <div v-if="query" class="generated-info mt-4">
      <h3 class="text-2xl font-bold mb-2">Generated SQL Query</h3>
