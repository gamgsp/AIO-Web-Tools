<template>
  <div class="tool-page">
    <h2 class="text-3xl font-bold mb-4">SQLite Query Builder</h2>
    <p class="text-lg mb-6">
      <strong>Description</strong>: The SQLite Query Builder helps you create SQLite queries effortlessly. Simply provide the table name, select columns, and add conditions.
    </p>
    ...
    <div v-if="query" class="generated-info mt-4">
      <h3 class="text-2xl font-bold mb-2">Generated SQLite Query</h3>
